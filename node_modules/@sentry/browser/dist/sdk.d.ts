...
export declare const defaultIntegrations: (CoreIntegrations.Dedupe | CoreIntegrations.InboundFilters | CoreIntegrations.FunctionToString | CoreIntegrations.ExtraErrorData | TryCatch | Breadcrumbs | GlobalHandlers | LinkedErrors | UserAgent)[];
/**
